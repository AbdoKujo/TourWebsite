...
class Command(BaseCommand):
    help = 'Import initial data from HTML files'
    ...
    def create_base_pages(self):
        ...
        if created:
            self.stdout.write(f'Created Home page')
            
            # Create sections for Home page
            self.create_home_page_sections(home_page)
        ...
        if created:
            self.stdout.write(f'Created Services page')
            
            # Create sections for About page
            self.create_about_page_sections(about_page)
        
        # Create Gallery page
        gallery_page, created = Page.objects.get_or_create(
            slug='gallery',
            defaults={
                'name': 'Gallery',
                'type': 'base'
        ...
        if created:
            self.stdout.write(f'Created Gallery page')
            
            # Create sections for Gallery page
            self.create_gallery_page_sections(gallery_page)
        ...
        if created:
            ...
            self.create_contact_page_sections(contact_page)
    
    def create_theme_pages(self):
        # Create theme pages
        theme_pages = [
            'Tangier', 'Essaouira', 'Merzouga', 'Ouzoud', 'Ourika', 
            'Agafay', 'LaPalmeraie', 'HotAirBalloon', 'ParaglidingAguergour', 'Imlil'
        ]
        ...
        for page_name in theme_pages:
            ...
            if created:
                self.stdout.write(f'Created Theme page: {page_name}')
                
                # Create sections for theme page
                self.create_theme_page_sections(page)
    
    def create_home_page_sections(self, page):
    ...
    def create_about_page_sections(self, page):
        # Create Header section
        header_section = Section.objects.create(
            page=page,
            name='header',
        ...
        about_items = [
            {
                ...
                'json_content': '{"link": "ouzoud.html", "link_text": "Read More"}',
                'order': 0
            },
            {
                'title': 'La Palmeraie',
                ...
                'json_content': '{"link": "LaPalmeraie.html", "link_text": "Read More"}',
                'order': 1
            },
            {
                'title': 'Agafay',
                ...
                'json_content': '{"link": "agafay.html", "link_text": "Read More"}',
                'order': 2
            },
            {
                'title': 'Ourika',
                ...
                'json_content': '{"link": "ourika.html", "link_text": "Read More"}',
                'order': 3
            },
            {
                'title': 'Essaouira',
                ...
                'json_content': '{"link": "Essaouira.html", "link_text": "Read More"}',
                'order': 4
            },
            {
                'title': 'Merzouga',
                ...
                'json_content': '{"link": "Merzouga.html", "link_text": "Read More"}',
                'order': 5
            },
            {
                ...
                'json_content': '{"link": "HotAirBalloon.html", "link_text": "Read More"}',
                'order': 6
            },
            {
                'title': 'Immobilier',
                ...
                'json_content': '{"link": "Immobilier.html", "link_text": "Read More"}',
                'order': 7
            },
            {
                ...
                'json_content': '{"link": "ParaglidingAguergour.html", "link_text": "Read More"}',
                'order': 8
            },
            {
                'title': 'Imlil',
                ...
                'json_content': '{"link": "imlil.html", "link_text": "Read More"}',
                'order': 9
            },
            {
                'title': 'Tangier',
                ...
                'json_content': '{"link": "Tangier.html", "link_text": "Read More"}',
                'order': 10
            }
        ]
    ...
    def create_gallery_page_sections(self, page):
        # Create Header section
        header_section = Section.objects.create(
            page=page,
            name='header',
    ...
    def create_contact_page_sections(self, page):
        # Create Header section
        header_section = Section.objects.create(
            page=page,
            name='header',
    ...
    def create_theme_page_sections(self, page):
        # Create Header section
        header_section = Section.objects.create(
            page=page,
            name='header',
